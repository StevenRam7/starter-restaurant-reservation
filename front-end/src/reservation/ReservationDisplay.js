...
function ReservationDisplay({reservations, loadDashboard}) {
   ...
   const displayReservations = reservations.map((reservation, index) => {
        return (
            <tr key={index}>
                ...
                <>
                  <button data-reservation-id-cancel={reservation.reservation_id} onClick={() => handleCancel(reservation.reservation_id)} 
